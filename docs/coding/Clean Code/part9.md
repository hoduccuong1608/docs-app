...
```java title='SerializedPageResponderTest.java'
...
```java title='SerializedPageResponderTest.java (refactored)''
...
```java title='EnvironmentControllerTest.java'
@Test
...
```java title='EnvironmentControllerTest.java (refactored)'
@Test
...
```java title='EnvironmentControllerTest.java (bigger selection)'
@Test
...
```java title='MockControlHardware.java'
...
```java title='SerializedPageResponderTest.java (Single Assert)'
public void testGetPageHierarchyAsXml() throws Exception {
